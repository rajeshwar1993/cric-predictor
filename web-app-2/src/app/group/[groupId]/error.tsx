...
export default function GroupError({ error, reset }: ErrorPageProps) {
  useEffect(() => {
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-[var(--sp-5)]">
      <div className="space-y-6 text-center">
        <Logo size="sm" />
        <h1 className="font-heading text-2xl font-bold text-[var(--text-primary)]">Wide ball.</h1>
        <p className="max-w-xs text-base text-[var(--text-secondary)]">
          Something went wrong loading this gang. Try again or head back.
        </p>
